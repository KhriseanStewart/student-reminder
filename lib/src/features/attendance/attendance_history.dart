          ...
          Container(
            ...
            child: TableCalendar(
              ...
              daysOfWeekStyle: DaysOfWeekStyle(
                ...
                weekendStyle: TextStyle(color: Colors.white), // Sat–Sun
              ),
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final clockOutAt = clockOutTimestamp != null
                        ? DateFormat(
                            'hh:mm a',
                          ).format(clockOutTimestamp.toDate())
                        : 'Not Clocked Out';
                          ...
                          child: Card(
                            ...
                            child: ListTile(
                              ...
                              onTap: () {
                                ...
                                final clockTimestamp =
                                    data['clockInAt'] as Timestamp?;
                                final clockOutTimestamp =
                                    data['clockOutAt'] as Timestamp?;
